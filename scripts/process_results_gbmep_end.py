...
with open('results/res_pp_end.pkl', 'rb') as f:
    res_pp = pickle.load(f)

## Load results for the MEP model
with open('results/res_mep_end.pkl', 'rb') as f:
...
res_gbmep_start = {}
for file in glob.glob('results/res_gbmep_start_end/*.pkl'):
    with open(file, 'rb') as f:
        res_gbmep_start.update(pickle.load(f))

## Load results for the GB-MEP model
res_gbmep = {}
for file in glob.glob('results/res_gbmep_end/*.pkl'):
    with open(file, 'rb') as f:
        res_gbmep.update(pickle.load(f))

## Load results for the full GB-MEP model
res_gbmep_full = {}
for file in glob.glob('results/res_gbmep_full_end/*.pkl'):
    with open(file, 'rb') as f:
...
if not os.path.exists('results/res_qq_end'):
   os.makedirs('results/res_qq_end')

## Save as .pkl files
with open('results/res_qq_end/y_train.pkl', 'wb') as f:
    pickle.dump(y_train, f)
with open('results/res_qq_end/ks_train.pkl', 'wb') as f:
    pickle.dump(ks_train, f)
with open('results/res_qq_end/cvm_train.pkl', 'wb') as f:
    pickle.dump(cvm_train, f)
with open('results/res_qq_end/y_test.pkl', 'wb') as f:
    pickle.dump(y_test, f)
with open('results/res_qq_end/ks_test.pkl', 'wb') as f:
    pickle.dump(ks_test, f)
with open('results/res_qq_end/cvm_test.pkl', 'wb') as f:
