...
if not os.path.exists('results/res_gbmep_full_end'):
   os.makedirs('results/res_gbmep_full_end')
...
## Save the results
with open('results/res_gbmep_full_end/res_gbmep_full_end_' + str(suffix) + '.pkl', 'wb') as f:
