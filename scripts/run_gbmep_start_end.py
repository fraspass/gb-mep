...
if not os.path.exists('results/res_gbmep_start_end'):
   os.makedirs('results/res_gbmep_start_end')
...
## Save the results
with open('results/res_gbmep_start_end/res_gbmep_start_end_' + str(suffix) + '.pkl', 'wb') as f:
