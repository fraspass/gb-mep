...
if not os.path.exists('results_2020/res_gbmep_full'):
   os.makedirs('results_2020/res_gbmep_full')
...
## Save the results
with open('results_2020/res_gbmep_full/res_gbmep_full_' + str(suffix) + '.pkl', 'wb') as f:
